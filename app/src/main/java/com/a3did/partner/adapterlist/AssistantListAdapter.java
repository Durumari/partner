...
public class AssistantListAdapter extends BaseAdapter {
    ...
    private ArrayList<AssistantListData> listViewItemList = new ArrayList<AssistantListData>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AssistantListData listViewItem = listViewItemList.get(position);
    ...
    public void addItem(Drawable icon, String title, String desc) {
        AssistantListData item = new AssistantListData();
